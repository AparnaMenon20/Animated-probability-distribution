...
Draw samples from a binomial distribution and dynamically
...
def update_frame(frame_number, event_count, values, frequencies):
    ...
    for _ in range(event_count):
        frequencies[np.random.binomial(20, 0.25)] += 1
    ...
    show_bar_chart(f' Frequencies of {freq_sum:,} Binomially Distribution Random Values ' +
...
figure = plt.figure('Binomial Distribution')

values = list(range(1, 21))  # displaying values on y-axis
